...
/// I think we all now that including a .cpp file is ugly.
///@todo A cleaner way to separate the app details from the platform details 
#include "pez_app_skeleton.cpp"
